...
function testingFuzzy(){
    for (var index = 0; index < 1; index++) {
        var temp = randomIntFromInterval(0, 100);
        var hum = randomIntFromInterval(0, 100);
        var co = randomIntFromInterval(0, 100);
        var smoke = randomIntFromInterval(0, 300);
...
function fuzzy(temp, hum, co, smoke){
    var tempArr = new Array();
    var humArr = new Array();
    var coArr = new Array();
    var smokeArr = new Array();

    tempArr[0] = getGrade(temp, 0, 0, 20, 30);
    tempArr[1] = getGrade(temp, 20, 30, 50, 60);
    tempArr[2] = getGrade(temp, 50, 60, 100, 100);
    humArr[0] = getGrade(hum, 0, 0, 20, 30);
    humArr[1] = getGrade(hum, 20, 30, 50, 60);
    humArr[2] = getGrade(hum, 50, 60, 100, 100);
    coArr[0] = getGrade(co, 0, 0, 30, 40);
    coArr[1] = getGrade(co, 30, 40, 50, 70);
    coArr[2] = getGrade(co, 50, 70, 100, 100);
    smokeArr[0] = getGrade(smoke, 0, 0, 40, 50);
    smokeArr[1] = getGrade(smoke, 40, 50, 70, 80);
    smokeArr[2] = getGrade(smoke, 70, 80, 300, 300);

    var fuzzyValue = countFuzzy(tempArr, humArr, coArr, smokeArr);

    console.log("");
    console.log("==============================================");
    console.log("");
    console.log("Temp : " +temp);
    console.log("Temp low : " +tempArr[0]);
    console.log("Temp med : " +tempArr[1]);
    console.log("Temp high : " +tempArr[2]);
    console.log("");
    console.log("Hum : " +hum);
    console.log("Hum dry : " +humArr[0]);
    console.log("Hum med : " +humArr[1]);
    console.log("Hum wet : " +humArr[2]);
    console.log("");
    console.log("CO : " +co);
    console.log("CO low : " +coArr[0]);
    console.log("CO med : " +coArr[1]);
    console.log("CO high : " +coArr[2]);
    console.log("");
    console.log("Smoke : " +smoke);
    console.log("Smoke low : " +smokeArr[0]);
    console.log("Smoke med : " +smokeArr[1]);
    console.log("Smoke high : " +smokeArr[2]);
}

function countFuzzy(temp, hum, co, smoke){
    var fuzzy = 0;
    var TEMP = 0, TEMP_F = 0;

    var r = fuzzification(temp, hum, co, smoke);
    for (var i = 0; i < r.length; i++) {
        TEMP = TEMP + r[i];
    }
    r = defuzzification(temp, hum, co, smoke);
...
function fuzzification(temp, hum, co, smoke){
    var r = new Array();
    var index = 0;
    for (var i = 0; i < temp.length; i++) {
        for (var j = 0; j < hum.length; j++) {
            for (var k = 0; k < co.length; k++) {
                for (var l = 0; l < smoke.length; l++) {
                    r[index] = getMinimum(temp[i], hum[j], co[k], smoke[l]);
                    index++;
                }
            }
        }
...
function defuzzification(temp, hum, co, smoke){
    
}

function getGrade(x, a, b, c, d){
    var output = 0;
